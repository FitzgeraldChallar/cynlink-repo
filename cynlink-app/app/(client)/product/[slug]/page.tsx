    ...
    <Container className="flex flex-col md:flex-row gap-10 pb-10">
        ...
        <div className="w-full md:w-1/2 flex flex-col gap-5">
           <div className="space-y-2 ">
            ...
            <p className="text-sm text-gray-600 tracking-wide font-serif">{product?.description}</p>
            <div className="flex items-center gap-0.5 text-xs">
                {[...Array(5)].map((_, index) => (
                    <StarIcon 
                      key={index}
                      size={12}
                      className="text-shop_light_gold"
                      fill={"#3b9c3c"}
                    />
                ))}
           ...
           <div className="space-y-2 border-b border-gray-200 py-5">
            <PriceView
               price={product?.price}
